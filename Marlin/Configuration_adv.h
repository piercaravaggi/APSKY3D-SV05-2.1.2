...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_NAME_1 "Front-Left Test 1st"
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 85*60, 85*60, 16*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define MEDIA_MENU_AT_TOP               // Force the media menu to be listed on the top of the main menu
   ...
   #define EVENT_GCODE_SD_ABORT "G91\nG1 E-2 F2700\nG1 E-2 Z0.2 F2400\nG1 X5 Y5 F3000\nG90\nG27 P2\nM220 S100\nM221 S100\nM104 S0\nM140 S0\nM107\nM84 X Y E" // sv05     // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
  ...
  /**
   * Set this option to one of the follo
   * ing (or the board's defaults apply):
   *
